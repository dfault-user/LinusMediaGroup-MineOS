...
local repositoryURL = "https://raw.githubusercontent.com/dfault-user/LinusMediaGroup-MineOS/master/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "MineOS: LMG Edition")
	return y + 2
end
...
local installerMenu = menu:addContextMenuItem("LMG", 0x2D2D2D)
